...
// NewGetOneTableParams creates a new GetOneTableParams object
// with the default values initialized.
func NewGetOneTableParams() *GetOneTableParams {
	var ()
	return &GetOneTableParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetOneTableParamsWithTimeout creates a new GetOneTableParams object
...
// NewGetOneTableParamsWithContext creates a new GetOneTableParams object
...
// NewGetOneTableParamsWithHTTPClient creates a new GetOneTableParams object
...
/*GetOneTableParams contains all the parameters to send to the API endpoint
for the get one table operation typically these are written to a http.Request
*/
type GetOneTableParams struct {
