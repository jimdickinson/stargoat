...
// NewCreateRowParams creates a new CreateRowParams object
// with the default values initialized.
func NewCreateRowParams() *CreateRowParams {
	var ()
	return &CreateRowParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateRowParamsWithTimeout creates a new CreateRowParams object
...
// NewCreateRowParamsWithContext creates a new CreateRowParams object
...
// NewCreateRowParamsWithHTTPClient creates a new CreateRowParams object
...
/*CreateRowParams contains all the parameters to send to the API endpoint
for the create row operation typically these are written to a http.Request
*/
